...
def cambio3d(request):
    if request.method == 'POST':
        ...
        #mensaje= f"Calibrando"

        # Aquí puedes realizar la lógica según el modelo_3d seleccionado
        ...
        # Renderizar la plantilla con los datos POST
        return render(request, 'cambio3denviado.html', {'modelo_3d': modelo_3d})

    # Si es una solicitud GET, simplemente renderiza la plantilla
    return render(request, 'cambio3d.html')
